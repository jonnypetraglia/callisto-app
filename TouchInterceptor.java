...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        ...
        mRemoveMode = pref.getInt("deletemode", FLING);
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    //Find the dragger in the item
                    View dragger = item.findViewById(R.id.itemdragger);
                    Rect r = new Rect();
                    dragger.getDrawingRect(r);
                    
                    /* 
                     * If the touch event was on the dragger, initiate dragging
                     * and seize control of the touch event
                     */
                    if (r.contains(x, y)) {
