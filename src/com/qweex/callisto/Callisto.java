...
/* VERSION NAMES:
 * 0.4 - Nebula		- Alpha; Basic Functionality, kind of there; documentation in the form of comments
 * 0.7 - Protostar	- Beta; includes all wanted functionality, but is unstable
 * 1.0 - Shiny Star - Stable
 * 2.0 - Red Giant	-  
 * X.X - White Dwarf
 * White Dwarf, Supernova, Black Hole/Neutron
 */
